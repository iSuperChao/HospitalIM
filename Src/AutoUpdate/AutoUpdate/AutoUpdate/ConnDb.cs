    ...
    public class ConnDbForAcccess
    {
        ...
        public ConnDbForAcccess()
        {
            string connStr = @"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" +
                                             ...
                                             @"Jet OLEDB:Database Password=****************;Mode=Share Deny Read|Share Deny Write";
           // connStr = "\\db.mdb;Jet OLEDB:database password=jh038972jh038972jh038972"; //从web.config配置中读取
           // connectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + Application.StartupPath + connStr;
